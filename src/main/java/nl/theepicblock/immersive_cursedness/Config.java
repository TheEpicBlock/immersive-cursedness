...
public class Config implements ConfigData {
	...
	final public transient double squaredAtmosphereRadius;
	final public transient double squaredAtmosphereRadiusPlusOne;
	final public transient double squaredAtmosphereRadiusMinusOne;
